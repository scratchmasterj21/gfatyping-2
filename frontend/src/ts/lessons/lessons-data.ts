...
// repsPerKey/bigramCount/ladderCount/wordCount/totalCap are all doubled from
// the original values (2026-07-30, per admin request - students were
// clearing the 2-star advance gate on the first attempt, so lessons weren't
// providing enough repetition before moving on). repLen/maxWordLen are left
// alone since those control per-token difficulty, not practice volume.
